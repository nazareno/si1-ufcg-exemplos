...
public class Curriculo {
	...
	protected List<Pagina> montaCurriculo(String nome, String profissao,
		 ...
		 * informa‹o a partir do que foi dado pelo usu‡rio.
		 * 
		 * Por exemplo, tem o link do curr’culo lattes dele e n—s geramos mais
		 * dados.
		 */

		if(! validaNome(nome)){
			throw new InvalidArgument("ƒ necess‡rio sobrenome");
		}
