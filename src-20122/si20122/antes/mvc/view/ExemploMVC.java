...
import si20122.antes.mvc.mc.SistemaDeRegistro;
...
public class ExemploMVC extends ApplicationFrame {
	...
	public ExemploMVC(String title, final SistemaDeRegistro controller) {
		...
		controller.cadastraInteressadoNoModelo(view1);
		controller.cadastraInteressadoNoModelo(view2);
	...
	private JButton criaBotaoDeInput(final SistemaDeRegistro controller) {
		...
		//mesmo que 
		// button.addActionListener(new SistemaAdapter(controller));
